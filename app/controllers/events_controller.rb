class EventsController < ApplicationController
  ...
  private
    ...
    def event_params
      params.require(:event).permit(:name, :start_time, :end_time, :category_event_id, :description, :address, :city, :postcode, :link, :image, :category_country_id, :linkmap)
    end
end
