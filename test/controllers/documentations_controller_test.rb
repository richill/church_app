...
class DocumentationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create documentation" do
    assert_difference('Documentation.count') do
      post documentations_url, params: { documentation: { content: @documentation.content, title: @documentation.title, user_id: @documentation.user_id } }
    end
  ...
  test "should update documentation" do
    patch documentation_url(@documentation), params: { documentation: { content: @documentation.content, title: @documentation.title, user_id: @documentation.user_id } }
