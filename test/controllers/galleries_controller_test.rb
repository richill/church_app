...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { date: @gallery.date, description: @gallery.description, image: @gallery.image, name: @gallery.name, user_id: @gallery.user_id } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { date: @gallery.date, description: @gallery.description, image: @gallery.image, name: @gallery.name, user_id: @gallery.user_id } }
